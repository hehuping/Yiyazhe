 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = '/Public/images/user/'; //图片路径配置
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="33" style="background:white"><div style="width: 13px;"></div></td>\
      <td height="33" style="background:white;"><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#fff;"><img align="absmiddle" src="' + IMAGESPATH + 'icon_dialog.gif"/><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
       </td>\
      <td width="13" height="33" style="background:white;background:white"><div style="width: 13px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="13" style="background:white;background:white"></td>\
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="padding: 8px 20px; text-align: right;">\
                <input type="button" class="table_peyton" style="float:left" value="确 定" onclick="sendBack('+this.TID+');" id="_ButtonOK_test"/>\
                <input type="button" class="table_peyton" style="float:right" value="取 消" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
      <td width="13" style="background:white"></td>\
    </tr>\
    <tr>\
      <td width="13" height="13" style="background:white"></td>\
      <td style="background:white"></td>\
      <td width="13" height="13" style="background:white"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
'
